...
## Docker Image
The public Docker image is available on Docker Hub under the repository [rootpublic/grafana-alloy](https://hub.docker.com/r/rootpublic/grafana-alloy).
