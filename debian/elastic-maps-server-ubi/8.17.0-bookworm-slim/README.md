# Root Curated elastic-maps-server-ubi:8.17.0-bookworm-slim

Root-curated elastic-maps-server-ubi:8.17.0-bookworm-slim images provide a secure, lightweight, and convenient starting point for your containerized applications. Derived from the official Docker docker.elastic.co/elastic-maps-service/elastic-maps-server-ubi ([8.17.0](https://www.elastic.co/elastic-maps-service)).
...
- g10-permissive
- gnulib
- http://example.com/dummy-license
