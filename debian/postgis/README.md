...
## Docker Image
The public image can be retrieved from our public docker hub repository [rootpublic/postgis](https://hub.docker.com/r/rootpublic/postgis).
