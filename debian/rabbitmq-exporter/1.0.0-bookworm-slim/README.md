# Root Curated rabbitmq-exporter:1.0.0-bookworm-slim

Root-curated rabbitmq-exporter:1.0.0-bookworm-slim images provide a secure, lightweight, and convenient starting point for your containerized applications. Derived from the official Docker rabbitmq-exporter ([1.0.0](https://hub.docker.com/layers/kbudde/rabbitmq-exporter/1.0.0/images/sha256-e85b0050a7cf27cc6805bbbc83750b53ee9403e9a112879eaa2eb85e1aadbc9d?context=explore)).
...
## Source & Dockerfile
The Dockerfile and source code for this image are available in our [GitHub Repository](https://github.com/rootio-avr/public-image-catalog/tree/main/debian/rabbitmq-exporter/1.0.0-bookworm-slim/).
