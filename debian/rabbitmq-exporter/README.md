# Root Curated rabbitmq-exporter
...
## Docker Image
The public image can be retrieved from our public docker hub repository [rootpublic/rabbitmq-exporter](https://hub.docker.com/r/rootpublic/rabbitmq-exporter).
