...
## Docker Image
The public Docker image is available on Docker Hub under the repository name [rootpublic/eck-operator](https://hub.docker.com/r/rootpublic/eck-operator).
