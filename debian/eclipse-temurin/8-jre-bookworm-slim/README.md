# Root Curated eclipse-temurin:8-jre-bookworm-slim

Root-curated eclipse-temurin:8-jre-bookworm-slim images provide a secure, lightweight, and convenient starting point for your containerized applications. Derived from the official Docker eclipse-temurin ([8-jre-noble](https://hub.docker.com/layers/library/eclipse-temurin/8-jre-noble/images/sha256-5279cac58791226db36ef7da48332447943cac33cc979c43bb274deedcdbd8db?context=explore)).
...
## Source & Dockerfile
The Dockerfile and source code for this image are available in our [GitHub Repository](https://github.com/rootio-avr/public-image-catalog/tree/main/debian/eclipse-temurin/8-jre-bookworm-slim/).
