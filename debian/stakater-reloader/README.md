# Root Curated stakater-reloader
...
## Docker Image
The public image can be retrieved from our public docker hub repository [rootpublic/stakater-reloader](https://hub.docker.com/r/rootpublic/stakater-reloader).
