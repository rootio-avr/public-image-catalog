# Root Curated fluent-bit:3.2.2-bookworm-slim

Root-curated fluent-bit:3.2.2-bookworm-slim images provide a secure, lightweight, and convenient starting point for your containerized applications. Derived from the official Docker fluent/fluent-bit ([3.2.2](https://hub.docker.com/layers/fluent/fluent-bit/3.2.2/images/sha256-6b81ac90875cca1b895f9d6ba0b432fa8949699396acc9d3392dfb9c94403ba1)).
...
## Source & Dockerfile
The Dockerfile and source code for this image are available in our [GitHub Repository](https://github.com/rootio-avr/public-image-catalog/tree/main/debian/fluent-bit/3.2.2-bookworm-slim/).
